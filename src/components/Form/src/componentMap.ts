...
import RectangleSelect from './my-components/RectangleSelect.vue';
import InputSelect from './my-components/InputSelect.vue';
...
componentMap.set('RectangleSelect',RectangleSelect);
componentMap.set('InputSelect',InputSelect);
