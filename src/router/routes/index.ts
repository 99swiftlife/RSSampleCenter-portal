...
export const ClassifyIndexRoute: AppRouteRecordRaw = {
  path: '/classify',
  name: 'ClassifyRoute',
...
export const TaskIndexRoute: AppRouteRecordRaw = {
  path: '/task',
  name: 'TaskRoute',
  component: () => import('/@/views/demo/page/form/basic/task.vue'),
  meta: {
    title: t('任务管理页面'),
  },
};
...
export const basicRoutes = [LoginRoute, RootRoute, ...mainOutRoutes, REDIRECT_ROUTE, PAGE_NOT_FOUND_ROUTE, TokenLoginRoute, Oauth2LoginRoute, ClassifyIndexRoute, TaskIndexRoute];
