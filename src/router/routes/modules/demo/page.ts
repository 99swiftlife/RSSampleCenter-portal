...
const page: AppRouteModule = {
  ...
  children: [
    // =============================classify page start=============================
    {
      path: 'classify-page',
      name: 'ClassifyPage',
      component: () => import('/@/views/demo/page/form/basic/classify.vue'),
      meta: {
        title: t('routes.demo.page.classify'),
      },
    },
    {
      path: 'dataset-page',
      name: 'DatasetPage',
      component: () => import('/@/views/demo/page/form/basic/dataset.vue'),
      meta: {
        title: t('routes.demo.page.dataset'),
      },
    },
    {
      path: 'dynamic-page',
      name: 'DynamicPage',
      component: () => import('/@/views/demo/page/form/basic/dynamic.vue'),
      meta: {
        title: t('routes.demo.page.dynamic'),
      },
    },
    {
      path: 'integration-page',
      name: 'IntegrationPage',
      component: () => import('/@/views/demo/page/form/basic/integration.vue'),
      meta: {
        title: t('routes.demo.page.integration'),
      },
    },
    {
      path: 'crawler-page',
      name: 'CrawlerPage',
      component: () => import('/@/views/demo/page/form/basic/crawler.vue'),
      meta: {
        title: t('routes.demo.page.crawler'),
      },
    },
    // =============================classify page end=============================
    // =============================form start=============================
