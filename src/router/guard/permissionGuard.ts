...
const CLASSIFY_INDEX = PageEnum.CLASSIFY_INDEX;
const TASK_INDEX = PageEnum.TASK_INDEX;
...
const whitePathList: PageEnum[] = [LOGIN_PATH, OAUTH2_LOGIN_PAGE_PATH,SYS_FILES_PATH, TOKEN_LOGIN, CLASSIFY_INDEX, TASK_INDEX ];
